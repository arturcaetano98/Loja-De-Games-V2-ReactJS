...
function SwitchAcessorios() {
  ...
  const ConstroiListaSwitchAcessorios = () => itensAtual?.map((itemDaLista, key) => {
  ...
  const PaginacaoListaSwitchAcessorios = () => {
    return(
      <>
        <Stack spacing={2}>
                ...
                <Grid item xs={9}>
                  ...
                  <Box sx={{ width: '100%', mb: 10 }}>
                    <Grid container spacing={{ xs: 1, md: 3 }} columns={{ xs: 1, sm: 8, md: 12 }}>
                        {ConstroiListaSwitchAcessorios()}
                    </Grid>
                  </Box>
                </Grid>
                <Grid container justifyContent="center">
                   {PaginacaoListaSwitchAcessorios()}
                </Grid>
              </Grid>
          </Box>
        </Container>
...
export default SwitchAcessorios;
