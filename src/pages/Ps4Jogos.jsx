...
function Ps4Jogos() {
  ...
  const ConstroiListaPs4Jogos= () => itensAtual?.map((itemDaLista, key) => {
                ...
                <Grid item xs={9}>
                  ...
                  <Box sx={{ width: '100%', mb: 10 }}>
                    <Grid container spacing={{ xs: 1, md: 3 }} columns={{ xs: 1, sm: 8, md: 12 }}>
                        {ConstroiListaPs4Jogos()}
                    </Grid>
                  </Box>
                </Grid>
                <Grid container justifyContent="center">
                   {PaginacaoListaPs4Jogos()}
                </Grid>
              </Grid>
          </Box>
        </Container>
