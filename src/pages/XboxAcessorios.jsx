...
function XboxAcessorios() {
  ...
  const ConstroiListaXboxAcessorios = () => itensAtual?.map((itemDaLista, key) => {
  ...
  const PaginacaoListaXboxAcessorios = () => {
    return(
      <>
        <Stack spacing={2}>
                ...
                <Grid item xs={9}>
                  ...
                  <Box sx={{ width: '100%', mb: 10 }}>
                    <Grid container spacing={{ xs: 1, md: 3 }} columns={{ xs: 1, sm: 8, md: 12 }}>
                        {ConstroiListaXboxAcessorios()}
                    </Grid>
                  </Box>
                </Grid>
                <Grid container justifyContent="center">
                   {PaginacaoListaXboxAcessorios()}
                </Grid>
              </Grid>
          </Box>
        </Container>
