...
function XboxJogos() {
  ...
  const ConstroiListaXboxJogos = () => itensAtual?.map((itemDaLista, key) => {
                ...
                <Grid item xs={9}>
                  ...
                  <Box sx={{ width: '100%', mb: 10 }}>
                    <Grid container spacing={{ xs: 1, md: 3 }} columns={{ xs: 1, sm: 8, md: 12 }}>
                        {ConstroiListaXboxJogos()}
                    </Grid>
                  </Box>
                </Grid>
                <Grid container justifyContent="center">
                   {PaginacaoListaXboxJogos()}
                </Grid>
              </Grid>
          </Box>
        </Container>
