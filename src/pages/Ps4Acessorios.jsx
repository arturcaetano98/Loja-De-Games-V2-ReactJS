...
function Ps4Acessorios() {
  ...
  const ConstroiListaPs4Acessorios = () => itensAtual?.map((itemDaLista, key) => {
  ...
  const PaginacaoListaPs4Acessorios = () => {
    return(
      <>
        <Stack spacing={2}>
                ...
                <Grid item xs={9}>
                  ...
                  <Box sx={{ width: '100%', mb: 10 }}>
                    <Grid container spacing={{ xs: 1, md: 3 }} columns={{ xs: 1, sm: 8, md: 12 }}>
                        {ConstroiListaPs4Acessorios()}
                    </Grid>
                  </Box>
                </Grid>
                <Grid container justifyContent="center">
                   {PaginacaoListaPs4Acessorios()}
                </Grid>
              </Grid>
          </Box>
        </Container>
